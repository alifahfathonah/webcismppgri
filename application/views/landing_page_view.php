...
<div class="jumbotron header-cBelum Daftar Akun PSB Siswa? Klik Disiniontent" style="background-color: green;">
	<div class="text-center logo">
		<img src="<?php echo base_url() ?>assets/images/logopgri.png" style="max-width: 250px;"><br />
	</div>
...
<!--		Form Login User-->
		<form role="form" method="post" action="<?php echo base_url('user/action_login'); ?>">
			...
			<div class="form-group">
				<a href="<?php base_url() ?>index.php/Auth/register" data-toggle="tooltip" data-placement="right" title="Silahkan isikan data pada form pendaftaran">Belum Daftar Akun PSB Siswa? Klik Disini</a><br>
			</div>
