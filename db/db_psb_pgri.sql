...
CREATE TABLE `tb_calon_siswa` (
  ...
  `penghasilan_ayah` double(10,0) NOT NULL,
  `penghasilan_ibu` double(10,0) NOT NULL,
...
INSERT INTO `tb_calon_siswa` (`user_id`, `user_email`, `user_password`, `nama_lengkap`, `tanggal_lahir`, `tempat_lahir`, `jenis_kelamin`, `agama`, `alamat`, `nama_ibu_kandung`, `nama_ayah_kandung`, `pekerjaan_ibu`, `pekerjaan_ayah`, `penghasilan_ayah`, `penghasilan_ibu`, `sd_asal`, `un_total`, `foto_calon_siswa`, `tanggal`, `status_reg`) VALUES
(5, 'heri.prastio56@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', '1995-01-21', '', '', '', '', '', '', '', '', 0, 0, '', '', '', '2021-01-27', 0),
(7, '', '', 'RI Tes', '1995-09-22', 'Jakarta', '1', '1', 'Tes', 'Tes', 'Abc', 'Def', 'KA', 0, 0, 'San Fras', '', '75HUTRI7.jpg', '2021-01-29', 0),
(8, '', '', 'Akun PSB', '2021-01-28', 'Jakarta', 'Laki-laki', 'Islam', 'JL. TES', 'Tes', 'tes', 'Tis', 'Tes', 0, 0, 'JL. TES TEXT', '80.00', 'logopgrismpmini2.png', '2021-01-29', 1),
(9, '', '', 'Tes Data', '1998-04-22', 'Jakarta', 'Laki-laki', 'Islam', 'Tes doank', 'Tes', 'Data', 'Tis', 'Tes', 0, 0, 'Tes tiomini', '98.00', 'sklearn_google_colab.JPG', '2021-01-31', 0),
(10, '', '', 'Heri Prastio', '1998-02-22', 'Jakarta', 'Laki-laki', 'Islam', 'T', 'A', 'Tes', 'Def', 'Tes', 500, 0, 'EE', '3333', 'datasetimagedic2.JPG', '2021-01-31', 0),
(11, '', '', 'Satu', '2002-02-22', 'Jakarta', 'Laki-laki', 'Islam', 'A', 'A', 'Tes', 'Def', 'Tes', 500000, 500, 's', '90.00', 'PaintFunctionAskDicoding.png', '2021-01-31', 0),
(12, 'akundaftar@gmail.com', '$2y$10$GvMnD6itz/3wXhsmVWZG2Odh3be1s/MtjZHmK9lbdAP', 'Akun Daftar', NULL, '', '', '', '', '', '', '', '', 0, 0, '', '', '', '0000-00-00', 0);
